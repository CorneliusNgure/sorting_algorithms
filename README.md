...
2. Understand Big O notation and evaluate the time complexity of algorithms.
3. Learn to select the best sorting algorithm for different types of input data.
4. Understand the concept of a stable sorting algorithm.

Folder Structure
1. tests: Contains test files to validate sorting algorithms.
2. helper_files: Includes helper functions print_array.c and print_list.c to print arrays and linked lists, respectively.
3. header_files: Contains sort.h with function prototypes and deck.h for the deck of cards sorting task.
